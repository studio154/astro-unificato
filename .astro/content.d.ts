...
declare module 'astro:content' {
	...
	type DataEntryMap = {
		"edizioni": Record<string, {
  id: string;
  render(): Render[".md"];
  slug: string;
  body: string;
  collection: "edizioni";
  data: InferEntrySchema<"edizioni">;
...
"pagine": Record<string, {
  id: string;
  render(): Render[".md"];
  slug: string;
  body: string;
  collection: "pagine";
  data: InferEntrySchema<"pagine">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
...
"sessioni": Record<string, {
  id: string;
  render(): Render[".md"];
  slug: string;
  body: string;
  collection: "sessioni";
  data: InferEntrySchema<"sessioni">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
"store": Record<string, {
